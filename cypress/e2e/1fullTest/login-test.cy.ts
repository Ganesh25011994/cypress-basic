...
// import testData from '../../fixtures/loginResponse.json'
// import readExcel from '../../support/utils/readExcel'
...
//   let testdataFromexcel:any[];

//   beforeEach(() => {

//     cy.task('excelToJsonConverter', 'cypress/fixtures/loginTestData.xlsx').then((data) => {
//       console.log("data-writeFileSync", data)
//       Cypress.env('testData', data);
//       testCaseRun(data)
//     })
//     console.log("after before it function run")
//   });
...
//     source: fs.readFileSync('cypress/fixtures/loginTestData.xlsx')
//     // sourceFile: filePath
//   })
//   console.log("result", result)
//   let testData = result

//   console.log("excelData-console.log", testData)
//   // if (excelData$) {
//     testData.forEach((dataRow) => {
//       console.log("dataRow", dataRow)
//       it('sdfsadfsafdsadf', () => {
//         cy.log("dataRow-cylog", dataRow)
//       })
//     })
//   // }
...
//   //       cy.visit('/');
//   //       cy.log("testData-element", element)
//   //       cy.login(element.B, element.C)
//   //       cy.get('@loginData').then((data: any) => {
//   //         cy.log("@loginData value", data)
//   //         if(data.StatusCode == "000") {
//   //           cy.url().should('include', '/mpin');
//   //         } else {
//   //           cy.log(JSON.stringify(data))
//   //           expect(data.StatusCode).to.equals('001');
//   //           expect(data.Status).to.equals(element.D);
//   //         }
//   //       })
//   //   })
//   // })
...
//   //       // cy.contains(row.ExpectedText).should('be.visible');
//   //     });
//   //   });
//   // }
// }) 